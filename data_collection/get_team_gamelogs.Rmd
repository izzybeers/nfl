...
uninformative_stats_results = remove_uninformative_stats(df = team_gamelog_table, column_list = setdiff(colnames(team_gamelog_table), basic_cols))
...
team_gamelog_table = team_gamelog_table %>%
  mutate(Differential_Win = ifelse(Win == 1, Differential, NA)) %>%
  arrange(Season, Team) %>%
...
saveRDS(team_gamelog_table_season_end, 'saved_data_files/team_end_of_season_summary_stats.rds')
