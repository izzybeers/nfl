...
player_seasonal = readRDS('saved_data_files/player_end_of_season_summary_stats_with_team.rds')
...
saveRDS(list(rankings_receiving, rankings_rushing, seasonal_receiving_table, seasonal_rushing_table, qb_starters), 'saved_data_files/player_rankings_within_team.rds')
