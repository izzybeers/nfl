...
for (t in sort(unique(player_gamelogs$Team)))
{
  ...
  for (y in sort(unique(player_gamelogs$Season)))
  {
    ...
    rushing_subtable = rushing_subtable_all %>%
      ...
      mutate(Pct_Team_Rushing_Yds_Median_Season = Median_Rushing_Yds/Median_Offense_RushY,
        Pct_Team_Rushing_Yds_Median_Last3 = Last3_Median_Rushing_Yds/Last3_Median_Offense_RushY) %>%
