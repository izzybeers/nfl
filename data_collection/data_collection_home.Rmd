...
player_data = player_bios %>%
  ...
  mutate(On_Injury_List = ifelse(is.na(On_Injury_List), 0, On_Injury_List),
         ...
         game_on_birthday = ifelse(substring(player_data$birthday, 6, nchar(player_data$birthday)) == paste0(as.numeric(player_data$Month),'-', str_pad(str_extract(player_data$Date,'[0-9]+'), 2, 'left','0')), 1, 0),
...
saveRDS(passing_data, '../model/data/passing_preliminary_data.rds')
saveRDS(rushing_data, '../model/data/rushing_preliminary_data.rds')
saveRDS(receiving_data, '../model/data/receiving_preliminary_data.rds')
saveRDS(touchdown_data, '../model/data/touchdown_preliminary_data.rds')
