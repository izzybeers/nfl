...
uninformative_stats_results = remove_uninformative_stats(df = gamelogs_df, column_list = setdiff(colnames(gamelogs_df), c(basic_cols, team_cols)))

columns_to_remove = uninformative_stats_results[[1]]
columns_0_1 = setdiff(uninformative_stats_results[[2]], colnames(gamelogs_df)[str_detect(colnames(gamelogs_df), 'Cumulative_|Avg_|Last3_|Median_|Max_|Min_|_Per_|SD_|Lag|This_Season|Pct')])
low_medians = setdiff(uninformative_stats_results[[3]], colnames(gamelogs_df)[str_detect(colnames(gamelogs_df), 'Cumulative_|Avg_|Last3_|Median_|Max_|Min_|_Per_|SD_|Lag|This_Season|Pct')])
